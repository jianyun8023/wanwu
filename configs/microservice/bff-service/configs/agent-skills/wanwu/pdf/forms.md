...
### Why CIDFont and Built-in Fonts?

**Advantages**:
- ✅ No font files needed - Built into PDF readers
- ✅ Smaller PDF files - No font embedding required
- ✅ Perfect compatibility - Standard PDF fonts
- ✅ Full Unicode support - Complete character set
- ✅ Faster processing - No font file loading
- ✅ Avoids TTC errors - No TTC format issues
...
2. **Selects appropriate font**: 
   - Chinese text → STSong-Light (CIDFont, no font file needed)
...
```json
{
  "form_fields": [
    ...
    {
      "entry_text": {
        "text": "John Smith",  // Will use Times New Roman
        "font_size": 12
      }
    },
    {
      "entry_text": {
        "text": "ID: 12345",  // Will use Times New Roman
        "font_size": 12
      }
    }
  ]
