...
func registerWGA(apiV1 *gin.RouterGroup) {
	...
	mid.Sub("wga").Reg(apiV1, "/general/agent/tool/info", http.MethodGet, v1.GeneralAgentToolInfo, "通用智能体工具详情")
	...
	mid.Sub("wga").Reg(apiV1, "/general/agent/conversation/config/check", http.MethodPost, v1.GeneralAgentConfigCheck, "通用智能体配置检查")
	mid.Sub("wga").Reg(apiV1, "/general/agent/conversation/stream", http.MethodPost, v1.GeneralAgentConversionStream, "通用智能体流式问答")
	...
	mid.Sub("wga").Reg(apiV1, "/general/agent/conversation/workspace", http.MethodGet, v1.GeneralAgentWorkspace, "通用智能体workspace目录树")
